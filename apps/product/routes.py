...
read_product_category = Permission(RoleNeed("read_product category"))
write_product_category = Permission(RoleNeed("write_product category"))
delete_product_category = Permission(RoleNeed("delete_product category"))

read_period = Permission(RoleNeed("read_period"))
write_period = Permission(RoleNeed("write_period"))
delete_period = Permission(RoleNeed("delete_period"))

read_termOfPayment = Permission(RoleNeed("read_Term Of Payment"))
write_termOfPayment = Permission(RoleNeed("write_Term Of Payment"))
delete_termOfPayment = Permission(RoleNeed("delete_Term Of Payment"))
...
@login_required
@read_product_category.require(http_exception=403)
...
@write_product_category.require(http_exception=403)
...
@login_required
@delete_product_category.require(http_exception=403)
...
@login_required
@read_period.require(http_exception=403)
def period():
...
@login_required
@write_period.require(http_exception=403)
...
@login_required
@delete_period.require(http_exception=403)
def deletePeriod():
    id_del = request.form["id"]
    print( id_del)
...
@login_required
@read_termOfPayment.require(http_exception=403)
def termOfPayment():
...
@login_required
@write_termOfPayment.require(http_exception=403)
def editTerm():
    json_data = request.get_json()
...
@login_required
@delete_termOfPayment.require(http_exception=403)
def deleteTerm():
    id_del = request.form["id"]
    print( id_del)
