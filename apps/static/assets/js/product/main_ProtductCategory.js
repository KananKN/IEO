...
function sweetAlertDel(id) {
    swal({
        ...
        if (result.dismiss !== "cancel") {
            post("product/delete_productCategory", { id: id });
        }
    });
}
...
function func_modal(mode, data) {
    ...
    if (mode == 'add') {
        ...
        $('[name="id"]').val(data.id);
        $('[name="name_product"]').val(data.name);
...
function func_save(mode, x) {
    ...
    console.log(mode)
    console.log($('[name="name_product"]').val())
    ...
    if (details['name_product'].trim() == '') {
        check_fail('กรุณากรอกชื่อ')
        return
    } 
    
        if (mode == 'add') {
            fetch("product/add_productCategory", {
                    method: "post",
                    headers: {
        ...
        // alert(mode)
        fetch("product/edit_productCategory", {
                method: "post",
                headers: {
                    "Content-Type": "application/json",
                },
